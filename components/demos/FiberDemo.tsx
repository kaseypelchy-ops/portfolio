  ...
  return (
    <div className="demo-shell">
      <div className="demo-toolbar">
        <div><p className="eyebrow">Synthetic geometry demo</p><h3>Service-area matching pipeline</h3></div>
      ...
      <div className="spatial-demo">
        <svg viewBox="0 0 100 80" role="img" aria-label="Synthetic service area polygon and candidate points">
        ...
        <div className="spatial-copy">
          <strong>{step === 0 ? "Raw service geometry" : step === 1 ? "Candidate universe reduced" : step === 2 ? "Exact spatial match" : step === 3 ? "Matched records highlighted" : "Ready to normalize"}</strong>
          <p>{step < 2 ? "The visualization shows how cheap spatial filtering can reduce expensive exact matching." : "Only fictional candidate points inside the synthetic service polygon remain relevant."}</p>
